                ...
                if (provider != "thirdParty"){
                    if (! obj.stream.drmProtect){
                        if(obj["stream"][provider]["dash"]["high"] != null){
                            anchor.href="Player/player?videoUrl="+baseUrl+obj["stream"][provider]["dash"]["high"];
                        }
                        else{
                            anchor.href="Player/player?videoUrl="+baseUrl+obj["stream"][provider]["dash"]["base"];
                        }
                    }
                    else{
                        if(obj["stream"][provider]["dash"]["high"] != null){
                            anchor.href="Player/playerDRM?videoUrl="+obj["stream"][provider]["dash"]["high"]+"&drm="+drmLicenceUrl+obj["stream"]["videoHash"];
                        }
                        else{
                            anchor.href="Player/playerDRM?videoUrl="+obj["stream"][provider]["dash"]["base"]+"&drm="+drmLicenceUrl+obj["stream"]["videoHash"];
                        }
                    }
                }
                else{
                    if(obj["stream"][provider]["webHlsUrl"] != null){
                        anchor.href="Player/player?videoUrl="+baseUrl+obj["stream"][provider]["webHlsUrl"];
                    }
                    else{
                        anchor.href="Player/player?videoUrl="+baseUrl+obj["stream"][provider]["hlsUrl"];
                    }
                }
